closest_station <- function(index, df){
  ...
  result <- c("brand_of_nearest_station_phdis" = brand_of_nearest_station_phdis,
              ...
              "stid_of_2nd_nearest_station_phdis" = stid_of_2nd_nearest_station_phdis,
              "stid_of_3rd_nearest_station_phdis" = stid_of_3rd_nearest_station_phdis,
              "brand_of_nearest_station_drdur" = brand_of_nearest_station_drdur,
              ...
              "stid_of_nearest_station_drdur" = stid_of_nearest_station_drdur,
              "stid_of_2nd_nearest_station_drdur" = stid_of_2nd_nearest_station_drdur,
              "stid_of_3rd_nearest_station_drdur" = stid_of_3rd_nearest_station_drdur,
              ...
              "stid_of_nearest_station_drdis" = stid_of_nearest_station_drdis,
              "stid_of_2nd_nearest_station_drdis" = stid_of_2nd_nearest_station_drdis,
              "stid_of_3rd_nearest_station_drdis" = stid_of_3rd_nearest_station_drdis,
